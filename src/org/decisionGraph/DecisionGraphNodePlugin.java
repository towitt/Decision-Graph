 ...
 * @author Tobias Witt
 */
public class DecisionGraphNodePlugin extends Plugin {
    // The shared instance.
    private static DecisionGraphNodePlugin plugin;

    /**
     * The constructor.
     */
    public DecisionGraphNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static DecisionGraphNodePlugin getDefault() {
        return plugin;
    }
